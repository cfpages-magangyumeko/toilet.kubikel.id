...
# Article Guide — toilet.kubikel.id
...
Source route evidence: sitemap XML, 988 routes discovered during packet generation
Reader community name: `Kubikel.id`
...
- Address the reader warmly as `Sobat Kubikel.id`, `Kawan Kubikel.id`, or `Teman Kubikel.id`. Use the exact opening salutation assigned inside the article file.
