---
article_id: TKI-10-03
title: "Menulis Spesifikasi Kubikel Berbasis Kinerja"
slug: "spesifikasi-kubikel-berbasis-kinerja"
...
date_modified: null
parent_topic: TKI-10
primary_intent: "Draft a neutral specification"
reader_community: "Kubikel.id"
reader_address: "Sobat Kubikel.id"
final_route: "/artikel/spesifikasi-kubikel-berbasis-kinerja.html"
...
# Menulis Spesifikasi Kubikel Berbasis Kinerja

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Menulis Spesifikasi Kubikel Berbasis Kinerja”
...
- **Primary intent:** Draft a neutral specification
...
- **Scope boundary:** Criteria require evidence; no brand lock
- **Final public route:** `/artikel/spesifikasi-kubikel-berbasis-kinerja.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Menulis Spesifikasi Kubikel Berbasis Kinerja**.
...
- `TKI-10-01` → `/artikel/format-survei-toilet-kubikel.html` — Format Survei Lapangan Toilet Kubikel
- `TKI-10-02` → `/artikel/cara-mengukur-panel-kubikel.html` — Cara Mengukur Area dan Menghitung Panel Kubikel
- `TKI-10-04` → `/artikel/checklist-tender-toilet-kubikel.html` — Checklist Tender Toilet Kubikel dan Hardware
...
- **Tie back to this article:** Keep the explanation specific to “Menulis Spesifikasi Kubikel Berbasis Kinerja”.
