---
article_id: TKI-13-02
title: "Pintu Seret dan Gap Berubah: Pemeriksaan Awal"
slug: "diagnosis-pintu-kubikel-seret"
...
date_modified: null
parent_topic: TKI-13
primary_intent: "Diagnose alignment issues"
reader_community: "Kubikel.id"
reader_address: "Sobat Kubikel.id"
final_route: "/artikel/diagnosis-pintu-kubikel-seret.html"
...
# Pintu Seret dan Gap Berubah: Pemeriksaan Awal

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Pintu Seret dan Gap Berubah: Pemeriksaan Awal”
...
- **Primary intent:** Diagnose alignment issues
...
- **Scope boundary:** Door symptom only; replacement is TKI-13-06
- **Final public route:** `/artikel/diagnosis-pintu-kubikel-seret.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Pintu Seret dan Gap Berubah: Pemeriksaan Awal**.
...
- `TKI-13-03` → `/artikel/diagnosis-kunci-kubikel-macet.html` — Kunci dan Indikator Kubikel Macet
...
- **Tie back to this article:** Keep the explanation specific to “Pintu Seret dan Gap Berubah: Pemeriksaan Awal”.
