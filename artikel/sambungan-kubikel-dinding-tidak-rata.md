---
article_id: TKI-07-03
title: "Sambungan Kubikel ke Dinding Tidak Rata"
slug: "sambungan-kubikel-dinding-tidak-rata"
...
date_modified: null
parent_topic: TKI-07
primary_intent: "Resolve wall interfaces"
reader_community: "Kubikel.id"
reader_address: "Sobat Kubikel.id"
final_route: "/artikel/sambungan-kubikel-dinding-tidak-rata.html"
...
# Sambungan Kubikel ke Dinding Tidak Rata

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Sambungan Kubikel ke Dinding Tidak Rata”
...
- **Primary intent:** Resolve wall interfaces
...
- **Scope boundary:** Wall repair is outside scope
- **Final public route:** `/artikel/sambungan-kubikel-dinding-tidak-rata.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Sambungan Kubikel ke Dinding Tidak Rata**.
...
- `TKI-07-01` → `/artikel/detail-kubikel-zona-basah.html` — Detail Panel Kubikel di Zona Basah dan Cipratan
- `TKI-07-02` → `/artikel/perlindungan-tepi-panel-kubikel.html` — Melindungi Tepi dan Lubang Bor Panel Kubikel
- `TKI-07-04` → `/artikel/kaki-kubikel-dan-kemiringan-lantai.html` — Koordinasi Kaki Kubikel dengan Kemiringan Lantai
...
- **Tie back to this article:** Keep the explanation specific to “Sambungan Kubikel ke Dinding Tidak Rata”.
