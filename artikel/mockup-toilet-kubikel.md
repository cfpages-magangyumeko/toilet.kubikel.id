---
article_id: TKI-11-04
title: "Mockup Toilet Kubikel untuk Persetujuan Sistem"
slug: "mockup-toilet-kubikel"
description: "Control cutting, drilling, identity, delivery, and storage"
status: outline
publication_date: "2026-04-11"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TKI-11
primary_intent: "Approve interfaces before production"
reader_community: "Kubikel.id"
reader_address: "Kawan Kubikel.id"
final_route: "/artikel/mockup-toilet-kubikel.html"
...
sources:
  ...
  - "https://peraturan.bpk.go.id/Details/47614/uu-no-1tahun-1970"
  - "https://peraturan.bpk.go.id/Details/216875/permen-pupr-no-10-tahun-2021"
  - "https://peraturan.bpk.go.id/Download/211232/Permen%20PUPR_10_2021.pdf"
...
# Mockup Toilet Kubikel untuk Persetujuan Sistem

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Mockup Toilet Kubikel untuk Persetujuan Sistem”
- **Reader and situation:** Control cutting, drilling, identity, delivery, and storage
- **Reader outcome:** Control cutting, drilling, identity, delivery, and storage
- **Primary intent:** Approve interfaces before production
...
- **Scope boundary:** Mockup scope; finish sample is TKI-08-04
- **Final public route:** `/artikel/mockup-toilet-kubikel.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mockup Toilet Kubikel untuk Persetujuan Sistem**.
...
- **Original sources:** [UU No. 1 Tahun 1970 — BPK](https://peraturan.bpk.go.id/Details/47614/uu-no-1tahun-1970), [Permen PUPR No. 10 Tahun 2021 — BPK](https://peraturan.bpk.go.id/Details/216875/permen-pupr-no-10-tahun-2021), [full SMKK regulation PDF — BPK/JDIH source](https://peraturan.bpk.go.id/Download/211232/Permen%20PUPR_10_2021.pdf)
- **Purpose for this article:** Ground delivery, cutting/drilling, overhead support, glass handling, demolition, occupied retrofit, and commissioning in Indonesian safety duties.
- **Safe grounded facts:** People working and others present at a workplace require protection. Installation and retrofit content must start from assessed hazards, competent responsibilities, approved work controls, safe access, isolation/protection, and emergency arrangements rather than a generic DIY sequence.
- **Limits:** This file is not an RKK, JSA, lifting plan, method statement, or legal consolidation. Project HSE personnel must resolve `G-07`.
...
- `TKI-11-02` → `/artikel/isi-shop-drawing-kubikel.html` — Shop Drawing Kubikel: Isi Minimum sebelum Produksi
- `TKI-11-03` → `/artikel/inspeksi-fabrikasi-panel-kubikel.html` — Menilai Potongan, Lubang, dan Tepi Panel sebelum Kirim
- `TKI-11-05` → `/artikel/pengemasan-pengiriman-kubikel.html` — Penomoran, Pengemasan, dan Pengiriman Set Kubikel
- `TKI-11-06` → `/artikel/penyimpanan-material-kubikel.html` — Penyimpanan Panel dan Hardware di Proyek
...
- **Tie back to this article:** Keep the explanation specific to “Mockup Toilet Kubikel untuk Persetujuan Sistem”.
